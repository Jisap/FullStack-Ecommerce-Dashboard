...
type ColorFormValues = z.infer<typeof formSchema>; // Se crea un nuevo tipo -> sizeFormValues tendrá la misma estructura que el schema de z

const ColorForm: React.FC<ColorFormProps> = ({ initialData }) => { // Esta función permitirá crear, modificar o borrar un size
  ...
  const form = useForm<ColorFormValues>({ // Validación de los valores del formulario de react-hook-form según esquema de zod
      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-8">
            {/* CAmpo para subir el name del color */}
            <FormField 
            ...
            />
            {/* CAmpo para subir el value del color */}
            <FormField
              control={form.control} // Se pasa el controlador del campo de formulario <Form/> al componente <FormField />
              name="value"
              render={({ field }) => ( // render renderiza el campo del formulario con el arg.field que contiene el value, errores valid y el disabled
